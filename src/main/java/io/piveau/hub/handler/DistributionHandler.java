...
public class DistributionHandler {
    ...
    public void handleGetDistribution(RoutingContext context) {
        ...
        if (useIdentifier) {
            distributionsService.getDistributionByIdentifier(id, acceptType, getGetResponseHandler(context));
        } else {
            distributionsService.getDistribution(id, acceptType, getGetResponseHandler(context));
        }
    }

    private Handler<AsyncResult<JsonObject>> getGetResponseHandler(RoutingContext context) {
