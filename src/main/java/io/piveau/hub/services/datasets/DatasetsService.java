...
public interface DatasetsService {
    ...
    static DatasetsService create(TSConnector connector, DataUploadConnector dataUploadConnector, JsonObject config, PipeLauncher launcher, Vertx vertx, Handler<AsyncResult<DatasetsService>> readyHandler) {
        return new DatasetsServiceImpl(connector, dataUploadConnector, config, launcher, vertx, readyHandler);
    }
    ...
    @Fluent
    DatasetsService postDataset(String dataset, String contentType, Handler<AsyncResult<JsonObject>> handler);
