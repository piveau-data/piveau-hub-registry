...
public class MetricHelper {
    ...
    private MetricHelper(String content, String contentType, Handler<AsyncResult<MetricHelper>> handler) {
        try {
            data = JenaUtils.readDataset(content.getBytes(), contentType);
            oldName = data.listNames().next();
            model = data.getNamedModel(oldName);
    ...
    private MetricHelper(String id, String content, String contentType, String hash, String catalogueId, Handler<AsyncResult<MetricHelper>> handler) {
    ...
    public static void create(String content, String contentType, Handler<AsyncResult<MetricHelper>> handler) {
        new MetricHelper(content, contentType, handler);
    }

    public static void create(String id, String content, String contentType, String hash, String catalogueId, Handler<AsyncResult<MetricHelper>> handler) {
        new MetricHelper(id, content, contentType, hash, catalogueId, handler);
    }
