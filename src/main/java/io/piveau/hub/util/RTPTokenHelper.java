...
public class RTPTokenHelper {
    ...
    public void createKeycloakResource(WebClient client, String owner, String catalogueID) {
        ...
        if (catalogueID !=  null) {
            ...
            client.post(443, context.data().get("keycloak_uri").toString(), "/auth/realms/" + context.data().get("keycloak_realm").toString() + "/protocol/openid-connect/token")
                    .ssl(true)
                    .sendForm(createMultiMap(), ar -> {
                        if (ar.succeeded()) {
                            ...
                            if (!access_token.equals(null)) {
                                ...
                                client.post(443, context.data().get("keycloak_uri").toString(), "/auth/realms/" + context.data().get("keycloak_realm").toString() + "/authz/protection/resource_set/")
                                        .ssl(true)
                    ...
                    .sendForm(createMultiMap(), ar -> {
                        if (ar.succeeded()) {
                            ...
                            if (!access_token.equals(null)) {
                                ...
                                client.get(443, context.data().get("keycloak_uri").toString(), "/auth/realms/" + context.data().get("keycloak_realm").toString() + "/authz/protection/resource_set")
                                        .ssl(true)
                                        ...
                                        .send(ar_1 -> {
                                            if (ar_1.succeeded()) {
                                                ...
                                                if (rsid.contains(",")) {
                                                    ...
                                                    for (String id : ids) {
                                                        client.delete(443, context.data().get("keycloak_uri").toString(), "/auth/realms/" + context.data().get("keycloak_realm").toString() + "/authz/protection/resource_set/" + id)
                                                                .ssl(true)
                                                                .bearerTokenAuthentication(access_token)
                                                                .send(ar2 -> {
                                                                    if (ar.succeeded()) {
                                                ...
                                                client.delete(443, context.data().get("keycloak_uri").toString(), "/auth/realms/" + context.data().get("keycloak_realm").toString() + "/authz/protection/resource_set/" + rsid)
                                                        .ssl(true)
                                                        .bearerTokenAuthentication(access_token)
                                                        .send(ar2 -> {
                                                            if (ar.succeeded()) {
